...
- When committing or pushing code, never add Codex or Codex or Happy as an author or co-author. Do not include any `Co-Authored-By` lines referencing Codex/Anthropic/Happy.
